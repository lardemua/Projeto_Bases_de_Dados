...
void QUERY_INSERT_INTO_TABLE(void)
{
	...
	sprintf(query, "INSERT IGNORE registos VALUES(%d,%d,NOW(),%d,%.02f),(%d,%d,NOW(),%d,%.02f),(%d,%d,NOW(),%d,%.02f),(%d,%d,NOW(),%d,%.02f),(%d,%d,NOW(),%d,%.02f),(%d,%d,NOW(),%d,%.02f),(%d,%d,NOW(),%d,%.02f),(%d,%d,NOW(),%d,%.02f),(%d,%d,NOW(),%d,%.02f),(%d,%d,NOW(),%d,%.02f)", molde1, 1, miliseg, valor1, molde1, 2, miliseg, valor2, molde1, 3, miliseg, valor3, molde1, 4, miliseg, valor4, molde1, 5, miliseg, valor5, molde1, 6, miliseg, valor6, molde1, 7, miliseg, valor7, molde1, 8, miliseg, valor8, molde1, 9, miliseg, valor9, molde1, 10, miliseg, valor10);
	printf("%s\n", query);
