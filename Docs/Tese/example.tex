...
% -------------------------------------------------------------
\newcommand{\authorname}{Bruno Manuel \newline de Moura Ramos}         % Nome do autor da tese
...
\begin{figure}[H]
	...
	\end{center}
\end{figure}
\footnotetext{\textit{Ícones usados em esquemas e diagramas do projeto}. URL: \textbf{https://www.flaticon.com}}
...
\begin{figure}[H]
	...
	\end{center}
\end{figure}
\footnotetext{\textit{Imagem Molde de Injeção Aberto}. URL: \textbf{https://i1.wp.com/www.teameliteonline.com/wp-content/uploads/2015/08/colored-part-large-mold-with-part.jpg?fit=3008\%2C2000\&ssl=1}}
...
\begin{figure}[H]
	...
	\label{fig:softwares}
\end{figure}
\footnotetext[2]{\textit{Logo Ubuntu}. URL: \textbf{https://assets.ubuntu.com/v1/29985a98-ubuntu-logo32.png}}
\footnotetext[3]{\textit{Logo GNU}. URL: \textbf{https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/GNU \texttt{\char`_}Compiler\texttt{\char`_}Collection\texttt{\char`_}logo.svg/2000px-GNU\texttt{\char`_}Compiler\texttt{\char`_}Collection\texttt{\char`_}logo.svg.png}}
\footnotetext[4]{\textit{Logo Apache}. URL: \textbf{https://logodownload.org/wp-content/uploads/2018/03/apache-logo.png}}
\footnotetext{\textit{Logo MySQL}. URL: \textbf{https://logodownload.org/wp-content/uploads/2016/10/mysql-logo.png}}
...
\begin{figure}[H]
	...
	\end{center}
\end{figure}
\footnotetext{\textit{Imagem Web Development}. URL: \textbf{https://www.vectorstock.com/royalty-free-vector/web-development-php-html-arrows-vector-1713552}}
...
\begin{figure}
	\vspace{-2.5cm}
	\begin{center}
		\includegraphics[width=0.85\textwidth]{fluxograma_simples_transferencia_subprograma01} % Include the image placeholder.png
...
\begin{figure}
	\vspace{-1cm}
	\begin{center}
		\includegraphics[width=1\textwidth]{Esquema_Projeto_Total02} % Include the image placeholder.png
...
\begin{figure}
	\vspace{-1cm}
	\begin{center}
		\includegraphics[width=1\textwidth]{Esquema_Projeto_Total03} % Include the image placeholder.png
...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
	\pie [rotate = 180] {0/Tinham Conhecimentos, 20/Tinham Alguns Conhecimentos, 80/Não Tinham Conhecimentos}
	\end{tikzpicture}
...
\begin{enumerate}
	...
	\end{figure}
	\item Alterar cliente, 20\% dos utilizadores não inseriram toda a informação necessária para alterar um cliente e 20\% dos utilizadores detetaram erros na aplicação que tiveram de ser corrigidos a fim de terminar a tarefa
	\begin{figure}[H]
		\centering
		\begin{tikzpicture}
		\begin{axis}[ 
	...
	\end{figure}
	\item Validar a informação, 40\% dos utilizadores detetaram erros na aplicação que tiveram de ser corrigidos a fim de terminar a tarefa. Um dos utilizadores teve um pico de latência do servidor que causou o fecho da aplicação, deduziu-se que este pico foi falha do \textit{hardware} utilizado
	\begin{figure}[H]
		\centering
		\begin{tikzpicture}
		\begin{axis}[ 
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{futuro03} % Include the image placeholder.png
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{futuro04} % Include the image placeholder.png
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{exemplo_pavilhoes} % Include the image placeholder.png
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{exemplo_molde} % Include the image placeholder.png
...
\begin{figure}[H]
	\vspace{-2.5cm}
	\begin{center}
		\includegraphics[width=1\textwidth]{fluxograma_administracao03} % Include the image placeholder.png
