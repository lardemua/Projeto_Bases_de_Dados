...
\begin{figure}
	\vspace{-3cm}
	\begin{center}
		\includegraphics[width=.75\textwidth]{fluxograma_transferencia_programa3} % Include the image placeholder.png
		%\vspace{9cm}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.85\textwidth]{fluxograma_transferencia_subprograma3} % Include the image placeholder.png
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.5\textwidth]{placeholder} % Include the image placeholder.png
		\caption{fluxograma}
		\label{fig:backups1}
	\end{center}
\end{figure}
