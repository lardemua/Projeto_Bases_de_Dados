...
\begin{figure}[H]
	\begin{center}
		...
		\caption{SDSEGRTRETHRTHERTHRTHERTHRETHRTHRTHR\cite{Elmasri:2010:FDS:1855347}}
...
A \autoref{fig:relacional2} REPRESENTA UM EXEMPLOEDGDFGDFGDFGDFG.
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{placeholder} % Include the image placeholder.png
		\caption{SDSEGRTRETHRTHERTHRTHERTHRETHRTHRTHR\cite{Elmasri:2010:FDS:1855347}}
...
\bibliography{bib/own/molde.bib,bib/own/base_dados.bib}
